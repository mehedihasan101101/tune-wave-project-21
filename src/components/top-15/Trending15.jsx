    ...
    return (
        <div className="space-y-3">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 gap-x-11 gap-y-4">
                {trending15.map((eachTrendingSong, index) => <SongPlayCard key={eachTrendingSong.id} index={index} routeLink={routeLink} eachTrendingSong={eachTrendingSong}></SongPlayCard>)}
            </div>
